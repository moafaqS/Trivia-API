...
def create_app(test_config=None):
  ...
  def categories():
    ...
    formatted_categorys_dic = {}
    for c in categorys:
      formatted_categorys_dic[c.id] = c.type


    return jsonify({
      'success' : True,
      'categories' : formatted_categorys_dic
    })
  ...
  def search():
    ...
    try:
      ...
      current_selections = pagination(request,questions)
  ...
  def get_questions_per_categorie(id):
